...
export const IMAGE_URL = process.env.REACT_APP_IMG_URL;
  ...
  return (
    <SliderCardContainer
      ...
      <img
        ...
        className="poster"
        key={show.id}
        src={`${IMAGE_URL}/w500${show.poster_path}`}
        ...
        >
          ...
          <div className="hover-card-content">
            ...
            <div className="button-grp">
              <CardButton className="checked hover:bg-blue-300" onClick={handlePlay}>
                <span className="tooltiptext">Play</span>
                <BsPlayFill />
              </CardButton>
              <CardButton className=" hover:bg-green-500">
                <span className="tooltiptext">Like</span>
                <BsFillHandThumbsUpFill />
              </CardButton>
              <CardButton className=" hover:bg-red-500">
